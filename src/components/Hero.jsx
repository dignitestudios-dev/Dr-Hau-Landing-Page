  ...
  return (
    ...
    >
      <div className="text-white p-8 md:p-16 w-full md:w-1/2 ">
        <h1 className="text-4xl sm:text-5xl md:text-5xl font-normal pl-8">
          Welcome to
        </h1>
        <p className="text-[50px] sm:text-[60px] md:text-[85px] font-extrabold text-[#D0FCB3] pl-8 uppercase leading-tight m-0" style={{lineHeight: '1.1'}}>
  Dr. Hau’s 
  Clinic App
</p>
