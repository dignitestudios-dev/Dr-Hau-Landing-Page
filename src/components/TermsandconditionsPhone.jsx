...
const TermsandconditionsPhone = () => {
  return (
    <>
      <div className="bg-white px-8 md:px-20 lg:px-40 py-10">
        <h1 className="text-4xl font-bold mb-6">Terms and Conditions</h1>
        <p className="text-[18px]">
          By accessing and placing an order with Dr. Hau , you confirm that you
        ...
        <p className="text-[18px]">
          ...
          inability to use, the materials on this site, even if Dr. Hau team or
        ...
        <p className="text-[18px]">
          {" "}
          Dr. Hau will not be responsible for any outcome that may occur during
        ...
        <p className="text-[18px]">
          ...
          (referred to in these Terms & Conditions as "Dr. Hau ", "us", "we" or
          "our"), the provider of the Dr. Hau website and the services
        ...
        <ul className="list-disc pl-5">
          ...
          <li>
            <strong>Service:</strong> refers to the service provided by Dr. Hau
          ...
          <li>
            <strong>You:</strong> a person or entity that is registered with Dr.
            Hau to use the Services.
          </li>
        </ul>
        <br />
        ...
        <p className="text-[18px]">
          Thanks for shopping at Dr. Hau . We appreciate the fact that you like
        ...
        <p className="text-[18px]">
          ...
          order or making a purchase at Dr. Hau , you agree to the terms along
          with Dr. Hau â€™s Privacy Policy.
        </p>
        <p className="text-[18px]">
        ...
        <p className="text-[18px]">
          ...
          (collectively, "Suggestions") provided by you to Dr. Hau with respect
          to the website/app shall remain the sole and exclusive property of Dr.
          Hau .
        </p>
        <br />
        ...
        <p className="text-[18px]">
          ...
          contain links to other websites not operated or controlled by Dr. Hau.
        ...
        <p className="text-[18px]">
          ...
          using the Service. You acknowledge and agree that if Dr. Hau disables
        ...
        <p className="text-[18px]">
          Dr. Hau may from time to time provide enhancements or improvements to
        ...
        <h1 className="text-[24px] font-semibold pb-2">Third-Party Services</h1>
        <p className="text-[18px]">
        ...
        <p className="text-[18px]">
          ...
          or any other aspect thereof. Dr. Hau does not assume and shall not
        ...
        <h1 className="text-[24px] font-semibold pb-2">Term and Termination</h1>
        <p className="text-[18px]">
        ...
        <p className="text-[18px]">
          You agree to indemnify and hold Dr. Hau and its parents, subsidiaries,
        ...
        <p className="text-[18px]">
          ...
          extent permitted under applicable law, Dr. Hau, on its own behalf and
          ...
          foregoing, Dr. Hau provides no warranty or undertaking, and makes no
        ...
        <p className="text-[18px]">
          ...
          providers makes any representation or warranty of any kind, express or
          ...
          behalf of Dr. Hau are free of viruses, scripts, trojan horses, worms,
        ...
        <p className="text-[18px]">
          ...
          of Dr. Hau and any of its suppliers under any provision of this
        ...
        <p className="text-[18px]">
          ...
          term or any other term, and Dr. Hau’s failure to assert any right or
          provision under this Agreement shall not constitute a waiver of such
          right or provision. YOU AND Dr. Hau AGREE THAT ANY CAUSE OF ACTION
        ...
        <p className="text-[18px]">
          ...
          do not agree to the new terms, you are no longer authorized to use Dr.
          Hau.
        </p>
        <br />
        ...
        <p className="text-[18px]">
          The Agreement constitutes the entire agreement between you and Dr. Hau
          regarding your use of the website/app and supersedes all prior and
          contemporaneous written or oral agreements between you and Dr. Hau.
        </p>
        <br />

        <p className="text-[18px]">
          You may be subject to additional terms and conditions that apply when
          you use or purchase other Dr. Hau services, which Dr. Hau will provide
          to you at the time of such use or purchase.
        </p>
        <br />

        <h1 className="text-[24px] font-semibold pb-2">Updates to Our Terms</h1>
        <p className="text-[18px]">
        ...
        <p className="text-[18px]">
          ...
          written permission of Dr. Hau, unless and except as is expressly
        ...
        <p className="text-[18px]">
          In the event of a dispute, you or Dr. Hau must give the other a Notice
          ...
          any Notice of Dispute via email to: drhau@sculptdtla.com. Dr. Hau will
          send any Notice of Dispute to you by mail to your address if we have
          it, or otherwise to your email address. You and Dr. Hau will attempt
          ...
          days, you or Dr. Hau may commence arbitration.
        </p>
        <br />

        <h1 className="text-[24px] font-semibold pb-2">Binding Arbitration</h1>
        <p className="text-[18px]">
          If you and Dr. Hau don’t resolve any dispute by informal negotiation,
        ...
        <p className="text-[18px]">
          ...
          and will become the sole property of Dr. Hau without any compensation
          or credit to you whatsoever. Dr. Hau and its affiliates shall have no
        ...
        <h1 className="text-[24px] font-semibold pb-2">Typographical Errors</h1>
        <p className="text-[18px]">
        ...
        <p className="text-[18px]">
          ...
          representative of Dr. Hau. Dr. Hau will be entitled to injunctive or
          other equitable relief (without the obligations of posting any bond or
          surety) in the event of any breach or anticipatory breach by you. Dr.
          Hau operates and controls the Dr. Hau Service from its offices in the
          United States of America. The Service is not intended for distribution
          ...
          incorporate the Dr. Hau Privacy Policy) contain the entire
          understanding, and supersede all prior understandings, between you and
          Dr. Hau concerning its subject matter, and cannot be changed or
        ...
        <p className="text-[18px]">
          In no event shall Dr. Hau be liable for any special, direct, indirect,
        ...
        <p className="text-[18px]">
          ...
          accessible via the Dr. Hau Service. Without limiting the foregoing,
          Dr. Hau specifically disclaims all warranties and representations in
          any content transmitted on or in connection with the Dr. Hau Service
          or on sites that may appear as links on the Dr. Hau Service, or in the
          products provided as a part of, or otherwise in connection with, the
          Dr. Hau Service, including without limitation any warranties of
          merchantability, fitness for a particular purpose or non-infringement
          of third party rights. No oral advice or written information given by
          Dr. Hau or any of its affiliates, employees, officers, directors,
          ...
          foregoing, Dr. Hau does not warrant that the Dr. Hau Service will be
