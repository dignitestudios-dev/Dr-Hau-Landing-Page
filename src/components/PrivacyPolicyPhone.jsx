    ...
    <>
      <div className="bg-white px-8 md:px-20 lg:px-40 py-10">
        ...
        <p className="text-[18px]">
          ...
          collected, used, and disclosed by Dr. Hau.
        </p>
        <br />
        ...
        <p className="text-[18px]">
          ...
          Dr. Hau. By accessing or using our Service, you signify that you have
        ...
        <ul className="text-[18px] list-disc pl-5">
          ...
          <li>
            ...
            These numbers are usually assigned in geographic blocks and can
        ...
        <p className="text-[18px]">
          ...
          in becoming a Dr. Hau customer, we receive information from a third
          party that provides automated fraud detection services to Dr. Hau. We
          also occasionally collect information that is made publicly available
        ...
        <p className="text-[18px]">
          ...
          website/app in a shared location, and type of device used to visit the
          website/app. They may aggregate information about our advertising and
          what you see on the website/app and then provide auditing, research,
        ...
        <p className="text-[18px]">
          We keep your information only so long as we need it to provide Dr. Hau
        ...
        <p className="text-[18px]">
          ...
          absolute security of any information you transmit to Dr. Hau or
        ...
        <p className="text-[18px]">
          ...
          or from use of our help services may be transferred from time to time
          ...
          allowed by applicable law, by using any of the above, you voluntarily
        ...
        <p className="text-[18px]">
          ...
          information Dr. Hau collects depend on your relationship with Dr. Hau.
        ...
        <p className="text-[18px]">
          ...
          of the assets of Dr. Hau or any of its Corporate Affiliates (as
        ...
        <p className="text-[18px]">
          ...
          Dr. Hau, whether by ownership or otherwise. Any information relating
        ...
        <p className="text-[18px]">
          ...
          website/app. Your use of the website/app may also be subject to other
        ...
        <p className="text-[18px]">
          ...
          Policy, you should not engage with our website/app or use our
          services. Continued use of the website/app, direct engagement with us,
        ...
        <ul className="text-[18px] list-disc pl-5">
          ...
          <li>
            ...
            storage, similar to cookies but with a greatly enhanced capacity and
            no information stored in the HTTP request header.
          </li>
          <li>
            <strong>Sessions:</strong> We use "Sessions" to identify the areas
            of our platform that you have visited. A Session is a small piece of
        ...
        <p className="text-[18px]">
          ...
          the right thing to do. At Dr. Hau, we strongly believe that your data
        ...
        <p className="text-[18px]">
          ...
          requirements of GDPR. Dr. Hau processes or stores all personal data in
        ...
        <h1 className="text-[24px] font-semibold pb-2">California Residents</h1>
        <p className="text-[18px]">
        ...
        <ul className="text-[18px] list-disc pl-5">
          ...
          <li>
            <strong>Request Not to Sell Personal Data:</strong> You may request
        ...
        <p className="text-[18px]">CalOPPA users have the following rights:</p>
        <ul className="text-[18px] list-disc pl-5">
          <li>
            <strong>Right to Know and Access:</strong> You may submit a
            verifiable request for information regarding the: (1) categories of
        ...
        <ul className="text-[18px] list-disc pl-5">
          ...
          <li>
            ...
            <a href="https://www.dignitestudios.com/" className="text-blue-500">
